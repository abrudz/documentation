...
The result of a complete expression is displayed even where the result would normally be [shy](../../programming-reference-guide/introduction/results.md#shy-results).  In particular:
